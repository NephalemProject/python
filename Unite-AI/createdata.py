...
file_name = "D:/Nephalem/Documents/uniteTrainingData/training_data.npy"
file_name2 = "D:/Nephalem/Documents/uniteTrainingData/target_data.npy"
...
while True:
    count +=1
    last_time = time.time()
    image = grab_screen(region=(50, 100, 1100, 680)) # records this region of the screen
